...
const OwnerScreen = () => (
  <Stack.Navigator initialRouteName="InicioDueño">
    ...
    <Stack.Screen name="Recompensa"component={ServicesCre} options={{headerShown: false}}/>
...
const AppNavigator = () => {
  return (
    <NavigationContainer>
      ...
      <Stack.Screen name="Buyer" component={BuyerScreen} options={{headerShown: false}}/>
